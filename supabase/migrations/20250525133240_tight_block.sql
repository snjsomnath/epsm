/*
  ...
  3. Constructions
    - Basic wall, roof, floor assemblies
    - Window constructions
  4. Construction Sets
    - Default building element combinations
*/
...
SELECT * FROM ins_constructions;

-- Insert layers (would need actual IDs from previous inserts)
-- This is just an example structure, actual implementation would need proper ID references
/*
INSERT INTO layers (
  construction_id, material_id, glazing_id, layer_order, is_glazing_layer
) VALUES
  ((SELECT id FROM constructions WHERE name = 'Brick Wall with Insulation'), 
   (SELECT id FROM materials WHERE name = 'Brick'), NULL, 1, false);
*/
